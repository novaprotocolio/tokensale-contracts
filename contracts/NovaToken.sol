...
contract NovaToken is Controllable {

  using SafeMath for uint256;
  NovaTokenInterface public parentToken;
  ...
  address public masterWallet = 0x31Ebd457b999Bf99759602f5Ece5AA5033CB56B3;
  ...
  function NovaToken(
    ...
    ) public 
    {
      ...
      parentToken = NovaTokenInterface(_parentToken);      
  ...
  /**
  * Returns the total Nova token supply at the current block
  ...
  */
  ...
  /**
  * Returns the total Nova token supply at the given block number
  ...
  */
  ...
  /**
   * Lock the minting of Nova Tokens - to be called after the presale
   * @return {bool} success
  */
  ...
  * @return value {uint256} Value to add to the checkpoints ledger
  ...
  /**
  * Clones Nova Token at the given snapshot block
  ...
  * @return clonedTokenAddress {address}
  ...
  function createCloneToken(uint256 _snapshotBlock, string _name, string _symbol) public returns(address) {
      ...
      NovaToken cloneToken = tokenFactory.createCloneToken(
          this,
          _snapshotBlock,
          _name,
          _symbol
